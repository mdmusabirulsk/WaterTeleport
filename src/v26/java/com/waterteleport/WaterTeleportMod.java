...
/**
 * Main entrypoint for WaterTeleport mod on Minecraft 26.1.2.
...
public class WaterTeleportMod implements ModInitializer {
    ...
    // Entity registration using modern Minecraft 26.1.2 Identifier, Registries and BuiltInRegistries
    public static final Identifier THROWN_WATER_BUCKET_ID = Identifier.fromNamespaceAndPath(MOD_ID, "thrown_water_bucket");
    ...
    public void onInitialize() {
        LOGGER.info("Initializing WaterTeleport mod for Minecraft 26.1.2...");
        ...
        LOGGER.info("WaterTeleport mod initialized successfully.");
    }
}
