 ...
 * and environmental hazards during water bucket teleportation on Minecraft 1.20.1.
 */
@NullMarked
public final class TeleportSafetyHelper {
    ...
    public static boolean isSafeLandingSpot(Level level, BlockPos footPos) {
        ...
        if (footPos.getY() < level.getMinBuildHeight() || footPos.getY() >= level.getMaxBuildHeight() - 1) {
            return false;
        }
